...
class AppTheme {
  ...
  static final Color primaryColor = Color(0xFFFF7043);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(
      primary: LightThemeColors.primaryOrange,
      onPrimary: LightThemeColors.pureWhite,
      // ignore: deprecated_member_use
      primaryContainer: LightThemeColors.primaryOrange.withOpacity(0.1),
      onPrimaryContainer: LightThemeColors.pureWhite,

      // ignore: deprecated_member_use
      onPrimaryFixed: LightThemeColors.primaryOrange,
    ...
    textTheme: TextTheme(
      displayLarge: TextStyle(
        fontSize: 32.sp,
        fontWeight: FontWeight.w600,
        color: LightThemeColors.primaryOrange,
        fontFamily: 'Poppins',
      ),
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        backgroundColor: LightThemeColors.primaryOrange,
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        foregroundColor: LightThemeColors.primaryOrange,
        side: BorderSide(color: LightThemeColors.primaryOrange, width: 1.5),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(AppSizes.radiusMd),
        ),
        padding: EdgeInsets.symmetric(horizontal: 24, vertical: 14),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: BorderSide(color: LightThemeColors.primaryOrange, width: 2),
      ),
    ...
    expansionTileTheme: ExpansionTileThemeData(
      ...
      iconColor: LightThemeColors.primaryOrange,
      collapsedIconColor: LightThemeColors.primaryOrange,
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    colorScheme: ColorScheme.dark(
      primary: DarkThemeColors.primaryOrange,
      onPrimary: DarkThemeColors.pureWhite,
      // ignore: deprecated_member_use
      primaryContainer: DarkThemeColors.primaryOrange.withOpacity(0.1),
    ...
    textTheme: TextTheme(
      displayLarge: TextStyle(
        fontSize: 32.sp,
        fontWeight: FontWeight.w600,
        color: DarkThemeColors.primaryOrange,
        fontFamily: 'Poppins',
      ),
      displayMedium: TextStyle(
        fontSize: 26.sp,
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        backgroundColor: DarkThemeColors.primaryOrange,
        foregroundColor: DarkThemeColors.pureWhite,
        // elevation: 2,
        // shadowColor: DarkThemeColors.primaryOrange.withValues(alpha: 0.4),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(AppSizes.radiusMd),
        ),
        padding: EdgeInsets.symmetric(horizontal: 24, vertical: 14),
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        foregroundColor: DarkThemeColors.primaryOrange,
        side: BorderSide(color: DarkThemeColors.primaryOrange, width: 1.5),
        shape: RoundedRectangleBorder(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: BorderSide(color: DarkThemeColors.primaryOrange, width: 2),
      ),
      errorBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
    ...
    expansionTileTheme: ExpansionTileThemeData(
      ...
      backgroundColor: Colors.transparent,
      collapsedBackgroundColor: Colors.transparent,
      iconColor: DarkThemeColors.primaryOrange,
      collapsedIconColor: DarkThemeColors.primaryOrange,
